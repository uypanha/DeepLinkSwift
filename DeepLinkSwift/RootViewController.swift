    ...
    private func handleDeeplink() {
        if let mainNavigationController = current as? MainNavigationController, let deeplink = deeplink {
            ...
            case .messages(.details(let id)):
                mainNavigationController.showAlert(title: "Message", message: "This message id is: \(id)")
            case .request(.details(let id)):
                mainNavigationController.showAlert(title: "Request", message: "This request id is: \(id)")
            default:
